...
import ipadSection from '../../Assets/ipad-section.png';
...
const useStyles = makeStyles(() => ({
  ...
  backgroundBox: {
    width: '100%',
    background: `url(${ipadSection}) no-repeat`,
      ...
      <div className={classes.backgroundBox}>
        <div className={classes.textContainer}>
          <div className={classes.textBlock}>
            <div className={classes.h2}>AWESOME SCALABLE APPS</div>
            <div className={classes.h3}>Our Template acts & behaves truly as a Canvas.</div>
            <p>
